package com.morris.quizly.utils;
...
public class FileUtil {
    ...
    public static String base64partEncodedStr(Object binary) {
        ...
        byte[] sourceBytes;
        LOGGER.info(binary.getClass().getName());
        try {
    ...
    public static String base64EncodePDF(byte[] data, String contentType) {
        String encodedStr = Base64.getEncoder().encodeToString(data);
        return "data:" + contentType + ";base64," + encodedStr;
    }
